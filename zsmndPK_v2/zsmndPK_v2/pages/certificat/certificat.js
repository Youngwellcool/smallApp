...
Page({
  ...
  onLoad: function (options) {
    let data = { eid: app.globalData.eid }
  ...
  score() {
    wx.navigateTo({
      url: '/pages/achievement/achievement?data=' + encodeURIComponent(JSON.stringify(achievementData)) ,
    })
  },
  ...
  onShareAppMessage: function (res) {
    ...
    return {
      title: '我的艺术细胞逆天了，来测试一下你的艺术细胞含量吧',
      path: '/pages/index/index',
      imageUrl: app.util.getImagePrefixHost() +'/dayimage/simulation/shareimg.jpg'
    }
  }
})