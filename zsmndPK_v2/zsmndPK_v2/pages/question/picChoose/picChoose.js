// pages/question/picChoose/picChoose.js
var app = getApp();
var order;//当前题目序号
var timer;//计时器
...
Page({
  ...
  chooseAnswer:function(e){
    console.log('---选中值：' + e.target.id)
    if (clickFlag == false) {
      clearInterval(timer);//关闭定时器
      clickFlag = true;
      let data = { eid: app.globalData.eid, topictype: 2, tid: app.globalData.random[order - 1], sort: order, anid: e.target.id }
